...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.TaskCommentResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.TaskHistoryResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/teams/{id}/members/{user_id}/role": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.ChangeRoleRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/http.TeamStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "http.TeamStatsResponse": {
            "type": "object",
            "properties": {
                "average_close_time_seconds": {
                    "type": "number"
                },
                "tasks_by_status": {
                    "type": "object",
                ...
                "top_assignees": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.AssigneeStatResponse"
                    }
                },
                "total_comments": {
                    "type": "integer"
